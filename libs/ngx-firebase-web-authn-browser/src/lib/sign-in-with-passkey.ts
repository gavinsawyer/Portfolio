...
import { ClearChallengeFunctionRequest, ClearChallengeFunctionResponse, CreateAuthenticationChallengeFunctionRequest, CreateAuthenticationChallengeFunctionResponse, VerifyAuthenticationFunctionRequest, VerifyAuthenticationFunctionResponse } from "@portfolio/ngx-firebase-web-authn-server";
